<?php
/**
 * Handles making sure we load the latest version of the media library.
 *
 * The medialibrary will eventually be grossly refactored and moved into the /classes library.
*/
$it_registration_list_version   = '1.0.8';
$it_registration_list_library   = 'medialibrary';
